...
function EvenTypeFilterWidget() {
    ...
    */
    ...
    this.renderWidget = function () {
        var html = '<div class="grid-filter-type-label"><i>Тип события</i></div>\
    ...
    */
    this.loadCustomers = function () {
        var $this = this;
        $.post("GetEvenTypeNames", function (data) {
...
function RnionObjectFilterWidget() {
    /***
    * This method must return type of registered widget type in 'SetFilterWidgetType' method
    */
    this.getAssociatedTypes = function () {
        return ["RnionObjectNameFilterWidget"];
    };
    /***
    * This method invokes when filter widget was shown on the page
    */
    ...
    */
    ...
    this.renderWidget = function () {
        var html = '<div class="grid-filter-type-label"><i>Тип объекта</i></div>\
                    <div class="grid-filter-type-label">Выберите из списка:</div>\
                    <select style="width:250px;" class="grid-filter-type customerslist">\
                    </select>';
        this.container.append(html);
    ...
    */
    this.loadCustomers = function () {
        var $this = this;
        $.post("GetRnionObjectNames", function (data) {
            $this.fillCustomers(data.Items);
        });
    };
    /***
...
function RnionStatusFilterWidget() {
    /***
    * This method must return type of registered widget type in 'SetFilterWidgetType' method
    */
    this.getAssociatedTypes = function () {
        return ["RnionStatusNameFilterWidget"];
    };
    /***
    * This method invokes when filter widget was shown on the page
    */
    ...
    */
    ...
    this.renderWidget = function () {
        var html = '<div class="grid-filter-type-label"><i>Статус</i></div>\
                    <div class="grid-filter-type-label">Выберите из списка:</div>\
                    <select style="width:250px;" class="grid-filter-type customerslist">\
                    </select>';
        this.container.append(html);
    ...
    */
    this.loadCustomers = function () {
        var $this = this;
        $.post("GetRnionStatusNames", function (data) {
            $this.fillCustomers(data.Items);
        });
    };
    /***
