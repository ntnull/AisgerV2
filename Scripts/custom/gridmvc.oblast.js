...
function OblastFilterWidget() {
    ...
    */
    ...
    this.renderWidget = function () {
        var cultureIndex = this.lang.code;
        var oblname = "Области";
        ...
        console.log(cultureIndex);
        var html = '<p><i>' + oblname + '</i></p>\
                    <p>' + choose + ':</p>\
    ...
    */
    this.loadCustomers = function () {
        var $this = this;
        $.post("/Home/GetOblastName", function (data) {
