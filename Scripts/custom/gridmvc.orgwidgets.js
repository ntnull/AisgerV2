...
function OrgFilterWidget() {
    ...
    */
    ...
    this.renderWidget = function () {
        var html = '<div class="grid-filter-type-label"><i>Огранизация</i></div>\
    ...
    */
    this.loadCustomers = function () {
        var $this = this;
        $.post("GetOrganisationNames", function (data) {
