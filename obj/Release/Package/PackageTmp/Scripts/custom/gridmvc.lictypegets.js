...
function LicenseTypeFilterWidget() {
    ...
    */
    ...
    this.renderWidget = function () {
        var html = '<div class="grid-filter-type-label"><i>Тип лицензии</i></div>\
    ...
    */
    this.loadCustomers = function () {
        var $this = this;
        $.post("GetLicenseTypeNames", function (data) {
