...
function LicenseStatusFilterWidget() {
    ...
    */
    ...
    this.renderWidget = function () {
        var html = '<div class="grid-filter-type-label"><i>Статус лицензии</i></div>\
    ...
    */
    this.loadCustomers = function () {
        var $this = this;
        $.post("GetLicenseStatusNames", function (data) {
