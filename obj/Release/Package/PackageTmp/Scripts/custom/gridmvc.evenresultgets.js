...
function EvenResultFilterWidget() {
    ...
    */
    ...
    this.renderWidget = function () {
        var html = '<div class="grid-filter-type-label"><i>Результат события</i></div>\
    ...
    */
    this.loadCustomers = function () {
        var $this = this;
        $.post("GetEvenResultNames", function (data) {
