$(function () {
	...
	function getDicTypes() {
		...
		var data2 = [{ ID: -1, NAMERU: '-' },
			        { ID: 5, NAMERU: 'Перечень организаций по энергетическому аудиту за период с количеством проведенных энергоаудитов, по стране;' },
					{ ID: 38, NAMERU: 'К-во проведенных энергоаудитов, в разрезе энергоаудитов' }];
