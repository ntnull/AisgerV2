...
namespace Aisger.Models
{
    ...
    public partial class EAUDIT_IndustryForm11
    {
        ...
        public Nullable<double> FactValueHeating { get; set; }
        public Nullable<double> FactValueForcedVentilation { get; set; }
        public Nullable<double> FactValueHotWaterSupply { get; set; }
