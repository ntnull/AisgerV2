...
namespace Aisger.Models
{
    ...
    public partial class EAUDIT_IndustryForm19
    {
        public long Id { get; set; }
        public string Name { get; set; }
        public Nullable<double> Expenses { get; set; }
        public Nullable<double> SavingResourceInNatural { get; set; }
        public Nullable<double> SavingResourceInValue { get; set; }
        public string ImplementationDeadline { get; set; }
