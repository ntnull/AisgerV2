...
namespace Aisger.Models
{
    ...
    public partial class EAUDIT_IndustryForm13
    {
        public long Id { get; set; }
        public string Purpose { get; set; }
        public string AggregateNameTypeYear { get; set; }
        public Nullable<int> Quantity { get; set; }
        public Nullable<double> Performance { get; set; }
        public Nullable<double> SpecificFuelConsumptionFact { get; set; }
        public Nullable<double> SpecificFuelConsumptionFlowRatio { get; set; }
        public string HeatRecoveryEquipmentName { get; set; }
